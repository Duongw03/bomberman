    ...
    public void createMap() {
        for (int i = 0; i < HEIGHT; i++) {
            ...
            for (int k = 0; k < WIDTH; k++) {
                if (map_real[i][k] == '1') {
                    Entity balloon = new Balloon(k, i, Sprite.balloom_left1.getFxImage());
